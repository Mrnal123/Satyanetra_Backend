...
export async function GET(
  ...
  try {
    ...
    console.log("[v0] API Proxy: Fetching product score for", productId)

    const backendUrl = `${BACKEND_URL}/api/score/${productId}`
    ...
    try {
      ...
      console.log("[v0] Product score:", data.overallScore, "from", backendUrl)
