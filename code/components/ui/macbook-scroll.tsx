  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {children ? (
          <div className="absolute inset-0 rounded-lg overflow-y-auto overflow-x-hidden p-6 bg-[#1c1c1c] scrollbar-thin scrollbar-thumb-[#d425e3] scrollbar-track-[#272729]">
            {children}
          </div>
        ) : src ? (
          <img
